...
import { FiEdit, FiTrash, FiTrendingUp, FiBox, FiCpu, FiArchive, FiGlobe, FiX } from "react-icons/fi";
import { GiRunningShoe } from "react-icons/gi"
import { IoShirtOutline } from "react-icons/io5"
import Modal from 'react-modal'
import { v4 as uuidv4 } from 'uuid';

export default function SalesContents() {
                    ...
                    <div className={styles.table}>
                        <div className={styles.above_table}>
                            ...
                            <div className={styles.above_two}>
                                <a className={styles.above_two_title}>Sales</a>
                                <br />
